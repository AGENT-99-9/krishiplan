                    ...
                    <div className="hidden md:flex items-center gap-3">
                        {!isAuthenticated ? (
                            ...
                            <div className="flex items-center gap-4">
                                <Link to="/dashboard" className="text-sm font-medium text-gray-700 hover:text-krishi-600 transition-colors">
                    ...
                    <div className="px-4 py-4 space-y-1">
                        ...
                        <div className="pt-3 border-t border-gray-100 flex flex-col gap-2">
                            {!isAuthenticated ? (
                                ...
                                <>
                                    <Button to="/dashboard" variant="ghost" className="justify-center w-full" onClick={() => setMobileOpen(false)}>Dashboard</Button>
