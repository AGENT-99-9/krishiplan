...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-krishi-50 via-white to-krishi-100/60 px-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
                    ...
                    <p className="mt-6 text-center text-sm text-gray-500">
                        ...
                        <Link to="/signup" className="text-krishi-600 font-semibold hover:text-krishi-700">
                            Sign up
                        </Link>
                    </p>
                </div>
